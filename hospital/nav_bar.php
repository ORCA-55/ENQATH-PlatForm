<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <span class="text-gray-900 mr-2 " style="font-size: 20px;"><?php echo $_SESSION['hos_name']?></span>
            ...
            <a class="dropdown-item text-center small text-gray-500" href="#">عرض المزيد</a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $_SESSION['ha_name']?></span>
