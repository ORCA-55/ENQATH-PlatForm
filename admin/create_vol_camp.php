        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5 ">
                            <div class="text-center">
                                ...
                                <h2 class="h4 text-gray-700 mb-4">إضافة حملة تطوع</h2>
                            </div>
                            <form class="user" action="../admin/control/insert.php" method="post">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="date" class="form-control form-control-user" name="date" placeholder="التاريخ">
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <textarea class="form-control form-control-user" name="location" id="" cols="20" rows="2" style="border-radius: 0;" placeholder="موقع الحملة"></textarea>
                                ...
                                <input type="submit" name="create-vol-camp" class="btn btn-warning btn-user btn-block" value="إضافة الحملة">
                    ...
                    <i class="fa-sharp fa-solid fa-handshake-simple fa-lg" style="color: #ffffff;font-size: 8rem;margin: 20rem 10rem;"></i>
