...
<ul class="navbar-nav mr-auto">
    ...
    <li class="nav-item dropdown no-arrow d-sm-none">
        ...
        <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in"
            aria-labelledby="searchDropdown" style="right: -8rem;">
    ...
    <li class="nav-item dropdown no-arrow mx-1">
        ...
        <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
            ...
            <a class="dropdown-item text-center small text-gray-500" href="#">عرض المزيد</a>
        </div>
    </li>
    ...
    <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
            ...
            if($_SESSION['u_gender']==0){
            echo'<img class="img-profile rounded-circle"src="../img/undraw_profile_3.svg" alt="profile">';
            }else{
                echo'<img class="img-profile rounded-circle"src="../img/undraw_profile.svg" alt="profile">';
