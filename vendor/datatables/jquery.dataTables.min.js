...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"التالي",sPrevious:"السابق"},sEmptyTable:"لا يوجد بيانات متوفرة لعرضها",sInfo:"عرض _START_ إلى _END_ من مجموع _TOTAL_ مدخل",sInfoEmpty:"عرض 0 إلى 0 من مجموع 0 مدخل",
sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"عرض _MENU_مدخلات",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"البحث:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"لا يوجد نتائج لعملية البحث"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
